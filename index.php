...
<a class='btn btn-primary btn-sm' href='sistem_logout.php'>Logout</a>
    <div class="container my-5">
        ...
        <a class ="btn btn-primary" href="/PemwebFinal/create.php" role="button">Tambah Mahasiswa</a>
        <br>
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
              <?php  $servername = "localhost";
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    <td>
                        <a class='btn btn-primary btn-sm' href='/PemwebFinal/edit.php?Nomor=$row[Nomor]'>Edit</a>
                        <a class='btn btn-primary btn-sm' href='/PemwebFinal/delete.php?Nomor=$row[Nomor]'>Hapus</a>
                    </td>
                </tr>
                    ";
                }
